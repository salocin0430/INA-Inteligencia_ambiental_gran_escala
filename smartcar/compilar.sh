...
# Script para compilar SmartCar sin ejecutar
# Uso: ./compilar.sh
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "Para ejecutar vehículos, usa los scripts en scripts/:"
    echo "  ./scripts/ejecutar_vehiculo_normal.sh"
    echo "  ./scripts/ejecutar_vehiculo_policia.sh"
    echo "  ./scripts/ejecutar_vehiculo_ambulancia.sh"
    echo ""
else
    echo ""
