...
# Script para compilar PanelInformativo sin ejecutar
# Uso: ./compilar.sh
...
echo "=========================================="
echo "Compilando PanelInformativo"
echo "=========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "Para ejecutar el iniciador AWS, usa scripts/ejecutar_panel_aws.sh"
    echo ""
else
    echo ""
